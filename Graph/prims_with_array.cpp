// detail explanation on youtube: https://www.youtube.com/watch?v=xthRL0lcx2w
...
void findMST(int graph[V][V])
{
	...
	value[0] = 0;	//start node has value=0 to get picked 1st and it is also the min in value array and rest are infinity.
